    ...
    <div>
      <div className="m-10 mx-40 p-5  shadow-2xl">
        <h1 className="text-4xl font-semibold my-4 underline ">
          Careers at Genesis Tech
        </h1>
        <h1 className="text-2xl font-semibold my-2 mt-5 ">Join Our Team</h1>
        At Genesis Tech , we are committed to helping individuals achieve their
        ...
        At Genesis Tech , we believe in the power of collaboration. Our team
        ...
        Your work at Genesis Tech will have a direct impact on our clients’
        ...
        client has a positive experience with Genesis Tech .
        ...
        for a position at Genesis Tech , please send your resume and a cover
        letter to [career@Genesis Tech .ca](mailto:career@Resume Intellect.ca).
        <h1 className="text-2xl font-semibold my-2 mt-5">
          Join Us and Make a Difference
        </h1>
        At Genesis Tech , you’ll have the opportunity to make a meaningful
        impact every day. Join us and help shape the future of job seekers
        around the world. We look forward to welcoming you to our team!
      </div>
      <Footer />
    </div>
  );
