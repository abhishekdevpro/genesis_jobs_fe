  ...
  return (
    <div>
      <div className="m-10 mx-40 p-5  shadow-2xl">
        ...
        At Genesis Tech , we believe that every job seeker deserves a standout
        ...
        Upload your existing resume to the Genesis Tech platform. Our AI will
        ...
        Transform your resume with Genesis Tech ’s AI Resume Enhancer. Sign up
        now to create a resume that stands out and opens doors to new career
        opportunities.
