  ...
  return (
    <div>
      <div className="m-10 mx-40 p-5  shadow-2xl">
        <h1 className="text-3xl font-semibold my-4 underline ">
          {" "}
          Terms and Conditions
        </h1>
        <h1 className="text-lg font-semibold my-2 mt-5 "></h1>
        Welcome to Genesis Tech These terms and conditions outline the rules and
        ...
        Client: Any individual or entity using the services of Genesis Tech . -
        Company: Genesis Tech . - Services: Resume writing, career coaching,
        LinkedIn profile optimization, and other career-related services
        provided by Genesis Tech .
        ...
        Redistribution or resale of our services is prohibited. - Clients agree
        to use our services in a manner consistent with all applicable laws and
        regulations.
        <h1 className="text-lg font-semibold my-2 mt-5 ">
          3. Payment and Refunds
        </h1>
        - Payment for services must be made in full before the commencement of
        any work. - All fees are non-refundable unless otherwise stated in a
        specific service agreement. - In case of dissatisfaction with our
        services, clients must contact us within 7 days of receiving the final
        product. We will make reasonable efforts to address and rectify any
        issues.
        <h1 className="text-lg font-semibold my-2 mt-5 ">
          4. Intellectual Property
        </h1>
        - All content, materials, and services provided by Genesis Tech are
        ...
        - Genesis Tech respects the privacy and confidentiality of its clients.
        ...
        parties without explicit consent. - Clients agree not to disclose any
        confidential information obtained through our services to third parties.
        <h1 className="text-lg font-semibold my-2 mt-5 ">
          6. Limitation of Liability
        </h1>
        - Genesis Tech will not be liable for any direct, indirect, incidental,
        ...
        - Our services are provided on an as is and as available basis. Resume
        Intellect makes no warranties, express or implied, regarding the
        ...
        - Genesis Tech reserves the right to modify or update these terms and
        ...
        with the laws of the jurisdiction in which Genesis Tech operates. - Any
        ...
        Intellect.ca](mailto:career@Genesis Tech .ca) --- These terms and
        conditions are designed to ensure a clear understanding of our services
        and the responsibilities of both Genesis Tech and our clients. If you
        need any additional details or specific clauses included, please let me
        know!
      </div>
      <Footer />
    </div>
