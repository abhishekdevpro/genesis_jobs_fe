...
import logo from "./builderImages/logo.jpeg";
...
export default function WebBuilder() {
  ...
  return (
    <>
      <Meta
        title="Genesis Tech  - AI Resume Builder"
              ...
              <div className="hidden md:flex flex-col lg:flex-row items-center justify-between gap-4">
                ...
                <div className="hidden lg:flex items-center gap-4">
                  <select
                    ...
                    className="w-40 h-10 rounded-lg border border-green-500 px-4 font-bold text-black bg-white focus:ring-2 focus:ring-blue-800"
                  >
