...
const ATSResumeSection = () => {
  ...
  return (
    <div className="relative w-full min-h-[400px] bg-gradient-to-tl from-teal-500 to-black p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6 mb-12">
          ...
          >
            <button className="mt-4 bg-teal-600 hover:bg-teal-700 text-white font-medium py-3 px-6 rounded-lg transition-colors">
