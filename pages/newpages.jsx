  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="bg-gray-100 p-6 rounded-lg flex items-center gap-4">
        <div>
          <h2 className="text-xl font-bold ">GENESIS AI Resume Builder</h2>
          <p className="text-gray-700 text-sm mt-2">
            Applying for jobs has never been easier! GENESIS AI is an advanced
      ...
      <p className="text-center text-sm text-gray-600 mt-6">
        ...
        with GENESIS AI—the smarter way to build the perfect resume for every
        job application.
      </p>
    </div>
  );
